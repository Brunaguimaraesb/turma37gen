...
CREATE TABLE IF NOT EXISTS `db_blog_pessoal`.`tb_postagens` (
  ...
  INDEX `fk_tb_temas_has_tb_usuarios_tb_usuarios1_idx` (`fk_usuario_id` ASC) VISIBLE,
  INDEX `fk_tb_temas_has_tb_usuarios_tb_temas_idx` (`fk_tema_id` ASC) VISIBLE,
