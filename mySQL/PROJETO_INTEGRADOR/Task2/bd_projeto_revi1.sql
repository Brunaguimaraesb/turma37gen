...
CREATE TABLE IF NOT EXISTS `db_rede_social`.`tb_postagens` (
  ...
  INDEX `fk_tb_usuarios_has_tb_temas_tb_temas1_idx` (`fk_tema` ASC) VISIBLE,
  INDEX `fk_tb_usuarios_has_tb_temas_tb_usuarios_idx` (`fk_usuario` ASC) VISIBLE,
